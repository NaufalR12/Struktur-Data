...
int awallist = -1; // Indeks awal linked list
int akhirlist = -1; // Indeks akhir linked list
int listkosong = 0; // Indeks pertama dalam free list
...
void sisipDepan(elmn tmp) {
    if (listkosong == -1) {
        cout << "Error: Ruang memori penuh. Sisip depan tidak berhasil dilakukan." << endl;
        return;
    }
...
void sisipTengah(elmn tmp) {
    if (listkosong == -1) {
        cout << "Error: Ruang memori penuh. Sisip tengah tidak berhasil dilakukan." << endl;
        return;
    }
...
void sisipBelakang(elmn tmp) {
    if (listkosong == -1) {
        cout << "Error: Ruang memori penuh. Sisip belakang tidak berhasil dilakukan." << endl;
        return;
    }
