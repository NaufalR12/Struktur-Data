...
void tampilInfo(int indeks);
void tampilNext(int indeks);
void cetakDetail();
...
void menu() {
    ...
    cout << "6. Tampilkan Data Detail         " << endl;
    cout << "7. Keluar                        " << endl;
    cout << "=======================================" << endl;
...
void tampilInfo(int indeks) {
    cout << "Nomor Buku: " << elemen[indeks].info.noBuku << endl;
    cout << "Judul: " << elemen[indeks].info.judul << endl;
    cout << "Penulis: " << elemen[indeks].info.penulis << endl;
    cout << "Penerbit: " << elemen[indeks].info.penerbit << endl;
    cout << "Tahun Terbit: " << elemen[indeks].info.tahunTerbit << endl;
    cout << "Jenis Buku: " << elemen[indeks].info.jenisBuku << endl << endl;
}

void tampilNext(int indeks) {
    if (elemen[indeks].next != -1) {
        cout << "Next: " << elemen[indeks].next << endl << endl;
    } else {
        cout << "Next: NULL" << endl << endl;
    }
}
