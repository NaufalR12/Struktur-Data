...
public:
    ...
    void cariDataPasien() {
        ...
        cout << "2. Berdasarkan Huruf Awal Nama\n";
        cout << "Pilihan: ";
        int jenisPencarian;
        cin >> jenisPencarian;
        ...
        if (jenisPencarian == 1) {
            ...
            cin >> nama;
            cariNode(pohonTelusurBiner, nama, nama);
        } else if (jenisPencarian == 2) {
            string hurufAwal, hurufAkhir;
            cout << "Input Huruf Awal: ";
            cin >> hurufAwal;
            cout << "Input Huruf Akhir (biarkan kosong jika tidak ada batasan): ";
            cin.ignore();  // Ignore newline character in buffer
            getline(cin, hurufAkhir);
            if (hurufAkhir.empty()) {
                hurufAkhir = hurufAwal;
            }
            cariNode(pohonTelusurBiner, hurufAwal, hurufAkhir);
        } else {
    ...
    void cariNode(string namaAwal, string namaAkhir) {
